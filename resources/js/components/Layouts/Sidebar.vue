<template>
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" id="sidenav-main">
        <div class="sidenav-header">
            <i @click="toggleSidenav"  class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute right-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
            <a class="navbar-brand m-0">
                <img src="/img/logo-ct.png" class="navbar-brand-img h-100 w-15" alt="...">
                <span class="ms-1 font-weight-bold">FYCLS Ingeniería</span>
            </a>
        </div>
...
<!--                <li class="nav-item">-->
<!--                    <router-link :to="{ name: 'Workplace'}"  class="nav-link" >-->
<!--                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">-->
...
<!--                </li>-->
                <li class="nav-item">
                    <router-link :to="{ name: 'Publications'}"  class="nav-link" >
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/profile.html">
                        ...
                        <span class="nav-link-text ms-1">Técnicos</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="../pages/sign-up.html">
                        ...
                        <span class="nav-link-text ms-1">Parámetros</span>
                    </a>
                </li>
                </template>
            </ul>
...
.navbar-vertical .navbar-nav>.nav-item .nav-link.router-link-active .icon {
...
.navbar-vertical .navbar-nav > .nav-item .nav-link.router-link-active .icon svg .color-background, .navbar-vertical .navbar-nav > .nav-item .nav-link.router-link-active .icon svg .color-foreground {
    fill: #fff;
}
